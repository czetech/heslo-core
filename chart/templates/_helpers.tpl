...
Common labels
*/}}
{{- define "heslo-core.labels" -}}
helm.sh/chart: {{ include "heslo-core.chart" . }}
{{ include "heslo-core.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "heslo-core.selectorLabels" -}}
app.kubernetes.io/name: {{ include "heslo-core.name" . }}
