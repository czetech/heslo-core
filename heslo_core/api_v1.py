...
async def faq():
    return [{'head': "Kdo je autor projektu?",
            ...
            {'head': "Je to zadarmo?",
             'body': "V princípe áno, ale ak vďaka tejto aplikácii vyhráte, mali by ste sa s autorom rozdeliť. Ak sa chcete odvďačiť aj bez výhry, možete to spraviť na https://www.patreon.com/czepiec alebo napíšte na email."},
